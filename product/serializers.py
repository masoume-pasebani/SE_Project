...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id', 'name', 'description', 'image', 'quantity', 'price', 'rating', 'created_at', 'category', 'category_name', 'owner_email']
...
class ProductCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['name', 'description', 'image', 'quantity', 'price', 'created_at', 'category', 'owner']
